...
#management of input flags
flags = tf.flags     #shorten name space
logging = tf.logging #shorten name space
...
flags.DEFINE_string("data_path", None, "Folder where all data are.")
flags.DEFINE_string("save_path", None, "Folder where to save models.")

flags.DEFINE_boolean("testonly", False,"Set to True for testing only.")
